...
export default function NewComplaintPage() {
      ...
      if (selectedFile) {
        ...
        try {
          ...
          toast({
            ...
            description:
              uploadError.message ||
              'Failed to upload image. Submitting without image.',
            variant: 'destructive',
          });
        }
      }
  ...
  return (
    <div className="w-full max-w-full space-y-6 overflow-hidden">
      ...
      <Card className="w-full max-w-2xl">
        ...
        <CardHeader className="px-4 sm:px-6">
          ...
          <CardDescription>
            ...
            issue. You can also attach an image if relevant.
          </CardDescription>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-lg p-4 sm:p-6">
                ...
                {previewUrl ? (
                  ...
                  <div className="space-y-4">
                    ...
                    {/* Image Preview */}
                    <div className="relative w-full h-48 sm:h-64 rounded-lg overflow-hidden border bg-gray-50">
      ...
      {/* Tips Card */}
      <Card className="w-full max-w-2xl bg-blue-50 border-blue-100">
        ...
        <CardContent className="px-4 sm:px-6 text-sm text-gray-600 space-y-2">

          <p>
            • Be specific about the location (flat
            number, common area, etc.)
          </p>

          <p>
            • Describe when the issue started or was
            noticed
          </p>

          <p>
            • Include any relevant details that might
            help resolve the issue
          </p>

          <p>
            • Attach a clear photo if the issue is
            visible
          </p>
